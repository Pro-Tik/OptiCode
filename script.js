...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            fetch('https://opticode.pythonanywhere.com/api/quote', {
                method: 'POST',
    ...
    if (newsletterForm) {
        newsletterForm.addEventListener('submit', (e) => {
            ...
            fetch('https://opticode.pythonanywhere.com/api/subscribe', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const images = [
        ...
        './images/admin-dashboard.png', // Duplicated for demo (Replace with actual filenames)
        './images/student-dashboard.png',  // Duplicated for demo
        './images/mobile-install.png'
